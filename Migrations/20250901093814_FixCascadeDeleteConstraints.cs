...
namespace TravelSaaS.Migrations
{
    /// <inheritdoc />
    public partial class FixCascadeDeleteConstraints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgencyPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgencyPoints_Agencies_AgencyId",
                        column: x => x.AgencyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyPointId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AgencyPoints_AgencyPointId",
                        column: x => x.AgencyPointId,
                        principalTable: "AgencyPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Travels_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Travels_AgencyPoints_AgencyPointId",
                        column: x => x.AgencyPointId,
                        principalTable: "AgencyPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_AgencyPoints_AgencyPointId",
                        column: x => x.AgencyPointId,
                        principalTable: "AgencyPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_ConfirmedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgencyPoints_AgencyId",
                table: "AgencyPoints",
                column: "AgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_AgencyPoints_Name_AgencyId",
                table: "AgencyPoints",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AgencyPointId",
                table: "AspNetUsers",
                column: "AgencyPointId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_AgencyPointId",
                table: "Reservations",
                column: "AgencyPointId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Travels_AgencyId",
                table: "Travels",
                column: "AgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Travels_AgencyPointId",
                table: "Travels",
                column: "AgencyPointId");
        }
